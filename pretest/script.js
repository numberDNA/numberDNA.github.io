...
var timeLimits = { //Given in minutes
	multiplyWholeNumbers: Infinity, // 3, //0.25, //3,
	divideWholeNumbers: Infinity, // 3, //0.25, //3,
	divisibility: Infinity, // 3, //0.25, //3,
	factorWholeNumbers: Infinity, // 2, //0.25, //2,
	primeFactorization: Infinity, // 3, //0.25, //3,
	leastCommonMultiple: Infinity, // 3, //0.25, //3,
	greatestCommonFactor: Infinity, // 3, //0.25, //3,
	addSubtractIntegers: Infinity, // 3, //0.25, //3,
	multiplyDivideIntegers: Infinity, // 3, //0.25, //3,
	theNumberGame: Infinity, // 3, //0.25, //3,
	orderOfOperations: Infinity, // 3, //0.25, //3,
	equivalentFractions: Infinity, // 3, //0.25, //3,
	reducingFractions: Infinity, // 3, //0.25, //3,
	improperAndMixedFractions: Infinity, // 2, //0.25, //2,
	solveEquations: Infinity, // 8, //0.25, //8,
	addSubtractFractions: Infinity, // 8, //0.25, //8,
	multiplyDivideFractions: Infinity, // 8, //0.25, //8,
	exponents: Infinity, // 3, //0.25, //3,
	toScientificNotation: Infinity, // 2, //0.25, //5,
	fromScientificNotation: Infinity, // 2, //0.25, //5,
	decimals: Infinity, // 5, //0.25, //5,
	percents: Infinity, // 4, //0.25, //4,
	percentProblems: Infinity // 4 //0.25 //4
};
